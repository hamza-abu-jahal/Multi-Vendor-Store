...
class Product extends Model
{
    ...
    public function tags(){
         return $this->belongsToMany(
            Tag::class,      // related model   // اذا كنا ملتزمين بالتسمية نكتب فقط هذا المدخل
    ...
    protected static function booted()
    {
        ...
        static::addGlobalScope('store' , new StoreScope()); //  طريقة ب كلاس سكوب
